...
<table role="presentation" class="wrap" width="620" cellpadding="0" cellspacing="0" border="0"
  ...
  <tr><td class="pad" style="padding:8px 28px 22px 28px;font-family:Georgia,'Times New Roman',serif;">
    ...
    <div class="h1" style="font-size:32px;line-height:1.15;color:{{ ink }};margin-top:6px;">
  ...
  <tr><td style="padding:0 28px;"><div style="height:2px;background:{{ ink }};"></div></td></tr>

  {# ---------------- GLOBAL PULSE ---------------- #}
  <tr><td class="pad" style="padding:26px 28px 6px 28px;font-family:Helvetica,Arial,sans-serif;">
  ...
  {# ---------------- CREATIVE RADAR ---------------- #}
  <tr><td style="padding:14px 28px 0 28px;"><div style="height:1px;background:{{ rule }};"></div></td></tr>
  <tr><td class="pad" style="padding:24px 28px 6px 28px;font-family:Helvetica,Arial,sans-serif;">
  ...
  {# ---------------- FOOTER ---------------- #}
  <tr><td class="pad" style="padding:26px 28px 10px 28px;font-family:Helvetica,Arial,sans-serif;">
...
<tr><td class="pad" style="padding:12px 28px 0 28px;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr><td style="padding:20px 22px;font-family:Helvetica,Arial,sans-serif;">
      ...
      <div class="card-h" style="font-family:Georgia,'Times New Roman',serif;font-size:20px;
                  line-height:1.3;color:{{ ink }};margin-top:9px;">{{ topic.headline }}</div>
      ...
      <div style="margin-top:15px;">
        ...
        <div style="font-size:14px;line-height:1.62;color:{{ ink }};margin-top:5px;">
      ...
      <div style="margin-top:15px;padding:13px 15px;background:{{ paper }};border-radius:7px;">
        <div style="font-size:10px;letter-spacing:1.4px;text-transform:uppercase;
      ...
      <div style="margin-top:14px;font-size:12px;line-height:1.6;color:{{ muted }};">
        <span style="font-weight:bold;">
          {% if topic.conflict_detected %}Sources disagree{% else %}Still unclear{% endif %}:</span>
        {{ topic.uncertainties|join('; ') }}
      </div>
      {% endif %}

      <div style="margin-top:16px;padding-top:13px;border-top:1px solid {{ rule }};">
        <div style="font-size:10px;letter-spacing:1.4px;text-transform:uppercase;
